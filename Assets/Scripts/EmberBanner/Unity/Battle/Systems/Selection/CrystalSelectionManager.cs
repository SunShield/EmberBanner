    ...
    public class CrystalSelectionManager : EBMonoBehaviour
    {
        ...
        public void ProcessCrystalClick(BattleUnitCrystalView crystalView)
        {
            ...
            else
            {
                ...
                {
                    CardPrePlayManager.I.SetCardPrePlayedWithTarget(SelectedCard, CurrentCrystalWithCard,
                        SelectedCard.IsLegallyTargetingSelf(crystalView) 
                            ? CurrentCrystalWithCard 
                            : crystalView);
