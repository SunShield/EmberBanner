...
namespace EmberBanner.Core.Entities.Impl.Cards
{
    public class CardActionEntity : AbstractEntity<ActionModel>
    {
        ...
        public ComplexValue ClashingPowerGrowthSpan { get; private set; }
        public ComplexValue ClashingPowerGrowthRate { get; private set; }
        ...
        public CardActionEntity(int id, ActionModel model) : base(id, model)
        {
            ...
            ClashingPowerGrowthSpan = new ComplexValue(true,  model.ClashingPowerGrowthRate.Span);
            ClashingPowerGrowthRate = new ComplexValue(false, model.ClashingPowerGrowthRate.Growth);
